...
function save(req,res) {
            ...
            models.notification.create(notification).then(result =>{
                res.status(201).json({
...
function show(req,res) {
    ...
    models.notification.findByPk(id).then(result => {
        if(result) {
            res.status(200).json({
    ...
    function index(req,res) {
        models.notification.findAll().then(result => {
            res.status(200).json({
    ...
    function update(req,res) {
        ...
        const updatedUser = {
            ...
            models.notification.update(updatedUser, {where: {id: id}}).then(result => {
                res.status(200).json({
        ...
        function destroy(req,res) {
            const id = req.params.id;
            models.notification.destroy({where: {id: id}}).then(result => {
                res.status(200).json({
